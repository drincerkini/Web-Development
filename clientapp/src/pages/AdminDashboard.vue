...
<div class="col-lg-9 mt-4 mt-lg-0">
        ...
        <div class="user-dashboard-info-box table-responsive mb-0 bg-white p-4 shadow-sm">
          <table class="table manage-candidates-top mb-0">
            <thead>
              <tr>
                <th>FullName</th>
                <th class="action text-right">Email</th>
                <th class="action text-right">Role</th>
              </tr>
            </thead>
            <tbody>
              <tr class="candidates-list" v-for="user in users" :key="user.id">
                <td class="title">
                  <div class="candidate-list-details">
                    <div class="candidate-list-info">
                      <div class="candidate-list-title">
                        <!-- <h5 class="mb-0"><a href="#">Brooke Kelly</a></h5> -->
                        <td class="mb-0">{{ user.displayName }}</td>
                      </div>
                      <div class="candidate-list-option">
                        <ul class="list-unstyled">
                          <td class="mb-0">{{ user.surname }}</td>
                        </ul>
                      </div>
                    </div>
                  </div>
   ...
   <!-- <h1>Hello {{ $store.state.userModule.user.displayName }}!</h1> -->
</template>
