...
<div class="container">
    <div class="shop-default shop-cards shop-tech">
        <div class="row">
            <div class="col-md-6" v-for="product in this.womanproductslist" :key="product._id">
...
<!-- <div class="container ">
      <div class="">
        ...
        <section>
          <h3>Category</h3>
        <div class="d-flex">
          <div class="card" style="width: 18rem;" v-for="product in this.womanproductslist" :key="product._id">
